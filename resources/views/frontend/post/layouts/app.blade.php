...
<head>
    <title>| Creative Multi-Purpose HTML Template</title>
    <link rel="icon"  href="{{ URL::to('/') }}/media/settings/favicon/{{ $settings -> favicon }}">
    <meta charset="UTF-8">
...
<header id="topnav">
    <div class="container">
        ...
        <div class="logo">
            <a href="index-2.html">
                <img style="width: {{ $logo_info -> logo_width }}px;" src="{{ URL::to('/') }}/media/settings/logo/{{ $logo_info -> logo_light }}" alt="" class="logo-light">
                <img style="width: {{ $logo_info -> logo_width }}px;" src="{{ URL::to('/') }}/media/settings/logo/{{ $logo_info -> logo_dark }}" alt="" class="logo-dark">
            </a>
        </div>
        <!-- End Logo container-->
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-social">
                        <ul>
                            @php
                                $social_info = json_decode($settings -> social);
                            @endphp
                            <li>
                                <a target="_blank" href="{{ $social_info -> fb }}"><i class="ti-facebook"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_info -> tw }}"><i class="ti-twitter-alt"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_info -> lkdn }}"><i class="ti-linkedin"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_info -> itm }}"><i class="ti-instagram"></i></a>
                            </li>
                            <li>
                                <a target="_blank" href="{{ $social_info -> dbl }}"><i class="ti-dribbble"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
